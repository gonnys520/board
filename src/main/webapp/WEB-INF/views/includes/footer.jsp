...
<!-- /.container-fluid -->
<footer class="footer text-center"> &copy; 2018. gonnys. all rights reserved. </footer>
</div>
<!-- /#page-wrapper -->
</div>
<!-- /#wrapper -->
<!-- jQuery -->
    ...
    <script src="../resources/html/bootstrap/dist/js/bootstrap.min.js"></script>
    <!-- Menu Plugin JavaScript -->
    <script src="../resources/plugins/bower_components/sidebar-nav/dist/sidebar-nav.min.js"></script>
    <!--slimscroll JavaScript -->
    <script src="../resources/html/js/jquery.slimscroll.js"></script>
    <!--Wave Effects -->
    <script src="../resources/html/js/waves.js"></script>
    <!--Counter js -->
